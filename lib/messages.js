const messages = {
  ...
  outOfHintCredit: {
    message: "You ran out of hint credits! Hint credits will refill every few hours, so please check back later. ",
  ...
  serverError: {
    message: "This is most likely not on you, but we just hit a snag. Try again, and if it still doesn't work, let us know.",
