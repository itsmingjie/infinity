const messages = {
  ...
  notFound: {
    message:
      "The page you're looking for is either a cusp, a corner, an asymptote, or just does not exist. Try again? (If you are really not sure, <a href='/page/found'>this page</a> might help you out)",
  ...
  lockdown: {
    message:
      "We've been notified that the page you're trying to access is affected by an ongoing lockdown. Please try again later! (This can happen if \
        you are trying to get access to the puzzles before the competitions begin, or if you are trying to load the leaderboard towards the end of the competition.)",
    title: '⏳ Access Denied!'
  },
  caughtRedHanded: {
    message:
